...
@XmlEnumValue("INCOMING") INCOMING(String.valueOf("INCOMING")), @XmlEnumValue("OUTGOING") OUTGOING(String.valueOf("OUTGOING"));
  ...
  **/
  ...
  public FaxEmailTarget id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public FaxEmailTarget email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public FaxEmailTarget direction(DirectionEnum direction) {
    this.direction = direction;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class FaxEmailTarget {\n");
