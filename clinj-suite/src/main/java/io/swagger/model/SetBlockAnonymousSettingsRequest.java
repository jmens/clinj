...
public class SetBlockAnonymousSettingsRequest  {
...
@XmlEnumValue("REJECT") REJECT(String.valueOf("REJECT")), @XmlEnumValue("VOICEMAIL") VOICEMAIL(String.valueOf("VOICEMAIL"));
  ...
  **/
  ...
  public SetBlockAnonymousSettingsRequest enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }
  ...
  **/
  ...
  public SetBlockAnonymousSettingsRequest target(TargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class SetBlockAnonymousSettingsRequest {\n");
